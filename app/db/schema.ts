...
/** Manual "this scheduled charge is settled" overrides — see `docs/POCKET-MODEL.md`. */
export const chargePayments = sqliteTable(
  "charge_payments",
  {
    ...
    /** The scheduled charge date `YYYY-MM-DD` (as generated by the billing schedule). */
    dueDate: text("due_date").notNull(),
    paidAt: text("paid_at")
      .notNull()
      .default(sql`CURRENT_TIMESTAMP`),
  },
  (t) => [primaryKey({ columns: [t.subscriptionId, t.dueDate] })],
);
